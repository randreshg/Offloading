...
// $MYCLANG -fopenmp -fopenmp-targets=nvptx64 heat.c -o heat
// clang -lm -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda -Xopenmp-target -march=sm_80 heat.c -o heat
// LIBOMPTARGET_DEBUG=1 ./heat
